...
namespace WeatherAPI
{
    public partial class Form1 : Form
    {
        ...
        private void getData()
        {
            ...
            //generating a an API link on: open-meteo.com
            //e. g. var request = new RestRequest("forecast?latitude=47.67&longitude=-1.33&hourly=temperature_2m,precipitation,rain,snowfall,snow_depth&past_days=1&forecast_days=3");
            var request = new RestRequest("forecast?latitude=47.67&longitude=-1.33&hourly=temperature_2m,precipitation,rain,snowfall,snow_depth&past_days=1&forecast_days=3");
